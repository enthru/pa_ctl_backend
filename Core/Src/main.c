...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, DS2_Pin|DS1_Pin|PTT_OUT_Pin|PWR_CTL_Pin
                          |PTT_RELAY_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, RSRV_O_D_2_Pin|RSRV_O_D_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, BCD1_Pin|BCD2_Pin|BCD4_Pin|BCD8_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BCD8_IN_Pin BCD4_IN_Pin BCD2_IN_Pin BCD1_IN_Pin
                           PTT_IN_Pin RSRV_I_D_Pin */
  GPIO_InitStruct.Pin = BCD8_IN_Pin|BCD4_IN_Pin|BCD2_IN_Pin|BCD1_IN_Pin
                          |PTT_IN_Pin|RSRV_I_D_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  ...
  /*Configure GPIO pins : RSRV_O_D_2_Pin RSRV_O_D_1_Pin */
  GPIO_InitStruct.Pin = RSRV_O_D_2_Pin|RSRV_O_D_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : BCD1_Pin BCD2_Pin BCD4_Pin BCD8_Pin */
  GPIO_InitStruct.Pin = BCD1_Pin|BCD2_Pin|BCD4_Pin|BCD8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
